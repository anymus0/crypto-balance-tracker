...
export const thorAbi = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "blocktime", type: "uint256" }],
    name: "cashoutReward",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "bool", name: "newMode", type: "bool" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newGasDistri", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "nodeManagement", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address payable", name: "wall", type: "address" },
    ],
